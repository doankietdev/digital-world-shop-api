...
const passwordResetOtpSchema = new Schema(
  {
    ...
    expiresAt: {
      type: Date,
      default: Date.now() + AUTH.PASSWORD_RESET_OTP_LIFE
    }
  },
  {
    versionKey: false,
...
passwordResetOtpSchema.index(
  { updatedAt: 1 },
  { expireAfterSeconds: AUTH.PASSWORD_RESET_OTP_LIFE / 1000 }
)

export default model(MODEL_NAMES.PASSWORD_RESET_OTP, passwordResetOtpSchema)
